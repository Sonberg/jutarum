...
define('ember-load/services/ember-load-config', ['exports', 'ember'], function (exports, _ember) {
  'use strict';

  exports['default'] = _ember['default'].Service.extend({});
});
define("ember-load/templates/components/ember-load-remover", ["exports"], function (exports) {
  "use strict";
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        ...
        "moduleName": "modules/ember-load/templates/components/ember-load-remover.hbs"
      },
      isEmpty: false,
      arity: 0,
      cachedFragment: null,
...
define('ui-navigator-service/services/navigator', ['exports', 'ember', 'ember-getowner-polyfill'], function (exports, _ember, _emberGetownerPolyfill) {
  ...
  exports['default'] = _ember['default'].Service.extend({
    init: function init() {
      ...
      this.set('dRoute', (0, _emberGetownerPolyfill['default'])(this).lookup('route:animals.animal.size'));
    },
